...
jupyter nbconvert --execute Analysis_2021/6_Projection_Faldullah1.ipynb --to html
jupyter nbconvert --execute Analysis_2021/6_Projection_Faldullah2.ipynb --to html
...
jupyter nbconvert --execute Analysis_2022/6_Projection_Faldullah1.ipynb --to html
jupyter nbconvert --execute Analysis_2022/6_Projection_Faldullah2.ipynb --to html
